...
1) не забывай чистить using'и (удалять те импорты либ, которые в данном классе не используются). я все почистил, так что на будущее
...
4) enum'ы не надо оборачивать классом. 
5) правки по коду
